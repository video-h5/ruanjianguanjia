(function($){    
  $.fn.extend({
    slideFocusPlugin:function(options){
      ...
      var _slide = function(){
        if(Boolean(options.callbackFunBefore)){
              options.callbackFunBefore(_this.nextNum,_this.prevNum);
            }
      ...
      _this.tabTagArr.bind(_this.options.funType,function(){
        ...
        if(_this.prevNum > _this.tempNum){
          _this.animateDirection = -1;
        }else{
          _this.animateDirection = 1;
        }
        if(_this.options.funType == "mouseenter"){
      ...
      if(_this.options.funType == "mouseenter"){
        _this.tabTagArr.bind("mouseleave",function(){
          _this.hasNextPlay = false;
          clearTimeout(_this.delayTimeId);
        })
      }
